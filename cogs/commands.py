...
class comandos(commands.Cog): 
    ...
    async def embed_regras(self, ctx:commands.Context):
        ...
        regras_intro.description = (" Para manter o servidor organizado, seguro e agradável para todos, pedimos que leia atentamente as regras abaixo.\n\n"
        ...
        regras_convi.description = ("• Respeite todos os membros do servidor.\n"
        ...
        regras_chat.description =("• Evite spam, flood ou envio de mensagens repetitivas nos chats.\n"
        ...
        regras_seg.description = ("• Não envie links suspeitos, maliciosos ou conteúdos enganosos.\n"
